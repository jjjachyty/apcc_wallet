...
final EthereumAddress contractAddr =
    EthereumAddress.fromHex('0x2Fc8D2bBEcbefF293DC9305d537eCAa8eF55f726');

final contract = DeployedContract(
    ContractAbi.fromJson(abiCode, "TetherToken"), contractAddr);
...
Future<List> getUSDTBlance(String address) async {
  Credentials credentials = await client.credentialsFromPrivateKey(
      "0x68f80940c98719851873e9e41e28f9a98f15e73df918401c51f9a000e7d84db5");
  ...
  await client.sendTransaction(
      ...
      Transaction.callContract(
        ...
        parameters: [
          ...
          EtherAmount.inWei(BigInt.from(10).pow(18) * BigInt.from(amount)),
        ],
      ),
      chainId: 3333);
}
