            ...
            if (snapshot.hasData) {
              ...
              return Scaffold(
                ...
                body: Column(
                  ...
                  children: <Widget>[
                    Text(_news.title,style: Theme.of(context).textTheme.title, textAlign: TextAlign.center,),

                    Text("发布时间${_creteAt}",style: TextStyle(fontSize: 10,color: Colors.grey),textAlign: TextAlign.end,)
